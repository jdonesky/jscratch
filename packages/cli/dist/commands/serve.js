...
var local_api_1 = require("@jscratch/local-api");
            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (err_1.code === 'EADDRINUSE') {
                        console.error('Port is in use. Try running on a different port using option -p <number>');
                    }
                    else {
                        console.log("Here's the problem", err_1);
                    }
                    process.exit(1);
                    return [3 /*break*/, 3];
